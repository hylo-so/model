...
stab_mod1 = 1.2 # Stability mode 1 collaterization ratio threshold, usage of stability pool
stab_mod2 = 1.4 # Stability mode 2 collaterization ratio threshold, mint of fSOL disable

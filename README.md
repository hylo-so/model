...
## Limitations
This model primarily focuses on daily price returns, whereas, in practice, the protocol's stability is monitored on a minute-by-minute basis. Consequently, the model may occasionally indicate under-collateralization situations that the protocol, in real-time operations, could effectively manage and mitigate.

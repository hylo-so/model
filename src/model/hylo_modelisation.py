...
class Simulation:
    ...
    def run_simulation(
        ...
        results_csv_path = f'./output/simulations/run_{run_id}.{sub_run_id}-PATH_{price_path_id}-SOL_{stab_mode_hyUSD_SOL}-FEE_{stab_mode_fee_control}-xSOL_{stab_mode_hyUSD_xSOL}.csv'
